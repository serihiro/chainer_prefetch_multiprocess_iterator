...
def main():
    ...
    dataset = ExtendedLabeledImageDataset(
        pairs=args.train, root=args.root, measure=True
    )
    ...
    print(
        "initial_prefetch_multiprocess_iterator_cached_id_queue_size",
        iterator.initial_prefetch_multiprocess_iterator_cached_id_queue_size,
    )
    print("launch_thread_time", iterator.launch_thread_time)
    print(
        "start_generate_random_id_process_time",
        iterator.start_generate_random_id_process_time,
    )
    ...
    print(
        "generate_batch_thread_and_start_time",
        iterator.generate_batch_thread_and_start_time,
    )
